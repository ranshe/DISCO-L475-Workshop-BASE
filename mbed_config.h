...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                 "0071871579"                                                                                     // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                 WPA_WPA2                                                                                         // set by application[*]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                     "GVT-AAD5"                                                                                       // set by application[*]
...
#define MBED_CONF_SD_SPI_CLK                                                  D13                                                                                              // set by application[DISCO_L475VG_IOT01A]
#define MBED_CONF_SD_SPI_CS                                                   D10                                                                                              // set by application[DISCO_L475VG_IOT01A]
#define MBED_CONF_SD_SPI_MISO                                                 D12                                                                                              // set by application[DISCO_L475VG_IOT01A]
#define MBED_CONF_SD_SPI_MOSI                                                 D11                                                                                              // set by application[DISCO_L475VG_IOT01A]
...
#define MBED_CONF_UPDATE_CLIENT_APPLICATION_DETAILS                           (0x08000000+64*1024)                                                                             // set by application[DISCO_L475VG_IOT01A]
#define MBED_CONF_UPDATE_CLIENT_BOOTLOADER_DETAILS                            0x080082A0                                                                                       // set by application[DISCO_L475VG_IOT01A]
...
#define PAL_DNS_API_VERSION                                                   1                                                                                                // set by library:mbed-client-pal
#define PAL_INTERNAL_FLASH_SECTION_1_ADDRESS                                  (0x08000000+((1024-4)*1024))                                                                     // set by application[DISCO_L475VG_IOT01A]
#define PAL_INTERNAL_FLASH_SECTION_1_SIZE                                     (2*1024)                                                                                         // set by application[DISCO_L475VG_IOT01A]
#define PAL_INTERNAL_FLASH_SECTION_2_ADDRESS                                  (0x08000000+((1024-2)*1024))                                                                     // set by application[DISCO_L475VG_IOT01A]
#define PAL_INTERNAL_FLASH_SECTION_2_SIZE                                     (2*1024)                                                                                         // set by application[DISCO_L475VG_IOT01A]
#define PAL_INT_FLASH_NUM_SECTIONS                                            2                                                                                                // set by application[DISCO_L475VG_IOT01A]
// Macros
...
#define MBED_CONF_APP_MAIN_STACK_SIZE                                         7000                                                                                             // defined by application
